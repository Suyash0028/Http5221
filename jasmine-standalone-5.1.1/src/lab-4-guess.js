...
//Output messages
    ...
    var outOfRange = "Way off!!!! Pick between 1 and 10."; // Fixed it and changed the text as per mentioned in pdf [Suyash Kulkarni - 2024-02-02 2:00PM]
...
//Validate input and assign a return message
    ...
    } else if (guess < 1 || guess > 10) { //Fixed the range and now we can guess the number 1 to 10 inclusives [Suyash Kulkarni - 2024-02-02 2:00PM]
